...
if __name__ == "__main__":
    ...
    print(example_grid_problem.actions(state=((7,4), (False, False, False))))
    ...
    # add your own problems and try printing report. try adding the route problems from the slides or practice sets